import 'package:food_app/modals/offerModal.dart';
...
class DBHleper {
  ...
  final String OfferTableName = "Offerproduct";
  ...
  final String colStock = "stock";
  final String colisAdd = "isAdd";
  ...
  Future<int?> inserRecode({required Product data}) async {
    ...
    String query =
        "INSERT INTO $OfferTableName($colname,$colprice,$colimage,$colquantity,$collike)VALUES(?,?,?,?,?)";
  ...
  Future<int?> inserOfferRecode({required Offer data}) async {
    await initDB();

    // String query =
    //     "INSERT INTO $OfferTableName($colname,$colprice,$colimage,$colquantity,$collike)VALUES(?,?,?,?,?)";
    String query =
        "INSERT INTO $TableName($colname,$colimage)VALUES(?,?)";
